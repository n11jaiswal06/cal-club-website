...
export const metadata = {
  title: "Terms of Service | Cal Club",
  description: "Cal Club's Terms of Service.",
};

export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="6 September 2025">
      ...
      <ul>
        ...
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Cal Club LLP, Villa No.3,
          Chaithanya Swojas, Borewell Rd, Whitefield, Bengaluru, Karnataka, 560066, India.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Cal Club, accessible from www.thecalclub.com.
        </li>
        <li>
      ...
      <p>
        ...
        protects You. Please read Our <a href="/privacy">Privacy Policy</a> carefully before using
        Our Service.
      </p>
      ...
      <p>
        ...
        the foregoing shall be limited to the amount actually paid by You through the Service or INR
        5,000 if You haven&apos;t purchased anything through the Service.
      </p>
      <p>
      ...
      <h2>India Legal Compliance</h2>
      <p>
        You represent and warrant that (i) You are not located in a country that is subject to the
        Government of India embargo or sanctions, or that has been designated by the Government of
        India as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any
        Government of India list of prohibited or restricted parties.
      </p>
