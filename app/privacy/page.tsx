...
export const metadata = {
  title: "Privacy Policy | Cal Club",
  description: "Cal Club's Privacy Policy.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="16 May 2026">
      ...
      <h4>Health and Fitness Data</h4>
      <p>
        With Your explicit permission, the Application accesses health and fitness data from Apple
        Health (HealthKit) on iOS devices and Health Connect on Android devices. The specific
        categories of health data We access include:
      </p>
      <ul>
        <li>Step count</li>
        <li>Workout and exercise sessions (type, duration, distance where applicable)</li>
        <li>Active energy burned</li>
        <li>Resting energy burned / Basal Metabolic Rate (BMR)</li>
        <li>Heart rate</li>
        <li>Resting heart rate</li>
      </ul>
      <p>
        You may grant or revoke permission for each individual data type at any time through Your
        device settings (Settings → Health → Data Access &amp; Devices on iOS, or the Health Connect
        app on Android). Revoking permission will not delete data already used by the Application
        but will stop further access.
      </p>
      <p>
        <strong>How We collect this data:</strong> We do not collect health data directly from
        sensors. Health data is read from Apple HealthKit or Android Health Connect only after You
        explicitly grant the Application permission.
      </p>
      <p>
        <strong>How We store this data:</strong> Health and fitness data accessed by the Application
      ...
      <p>
        <strong>How We use this data:</strong> We use this health and fitness data solely to provide
        and improve the Application&apos;s core functionality, specifically to:
      </p>
      <ul>
        <li>Calculate Your Total Daily Energy Expenditure (TDEE) and calorie burn</li>
        <li>Adjust Your daily calorie and macronutrient targets based on actual activity</li>
        <li>Display Your workouts, steps, and activity trends within the Application</li>
        <li>Personalize recommendations and insights related to nutrition and fitness goals</li>
      </ul>
      <p>
        <strong>Sharing of health data:</strong> We do not sell your health and fitness data. We do
        not share it with third parties for advertising, marketing, or any purpose unrelated to the
        functionality You have requested. Health data is not transferred to any third party except
        our cloud infrastructure provider acting as a data processor under contract.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          small electronic files known as web beacons that permit the Company, for example, to count
      ...
      <ul>
        <li>
          <strong>Necessary / Essential Cookies</strong> (Session Cookies, administered by Us):
          essential to provide You with services available through the Website and to enable You to
          use some of its features. They help to authenticate users and prevent fraudulent use of
          user accounts.
        </li>
        <li>
          <strong>Cookies Policy / Notice Acceptance Cookies</strong> (Persistent Cookies,
          administered by Us): identify if users have accepted the use of cookies on the Website.
        </li>
        <li>
          <strong>Functionality Cookies</strong> (Persistent Cookies, administered by Us): allow us
          to remember choices You make when You use the Website, such as remembering your login
      ...
      <ul>
        ...
        <li>
          <strong>To contact You:</strong> by email, telephone calls, SMS, or other equivalent forms
          ...
          or contracted services, including security updates, when necessary or reasonable for their
          implementation.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>With Service Providers:</strong> to monitor and analyze the use of our Service, to
          contact You.
        </li>
        <li>
          <strong>For business transfers:</strong> in connection with, or during negotiations of,
          any merger, sale of Company assets, financing, or acquisition of all or a portion of Our
          business to another company.
        </li>
        <li>
          <strong>With Affiliates:</strong> in which case we will require those affiliates to honor
        ...
        <li>
          <strong>With business partners:</strong> to offer You certain products, services or
          promotions.
        </li>
        <li>
        ...
        <li>
          <strong>To provide health and fitness features:</strong> to read Your activity, workout,
          and energy data from Apple HealthKit or Android Health Connect in order to calculate
          calorie burn, adjust nutrition targets, and display fitness insights within the
          Application. This data is used only for the features You have enabled and is not used for
          advertising.
        </li>
      </ul>
